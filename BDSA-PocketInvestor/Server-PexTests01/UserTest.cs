...
namespace Server.UserData
{
    ...
    public partial class UserTest
    {
        ...
        {
            User target = new User(username, id, funds, investments, keyFile, iv, server);
            return target;
            // TODO: add assertions to method UserTest.Constructor(String, Int32, Decimal, List`1<InvestmentData>, Byte[], Byte[], ServerClass)
        }
    }
}
