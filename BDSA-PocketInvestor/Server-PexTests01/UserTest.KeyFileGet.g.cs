// <copyright file="UserTest.KeyFileGet.g.cs" company="Hewlett-Packard">Copyright © Hewlett-Packard 2011</copyright>
// <auto-generated>
...
public void KeyFileGet255()
{
    ...
    PexInvariant.SetField<byte[]>((object)user, "iv", bs1);
    PexInvariant.SetField<byte[]>((object)user, "keyFile", bs2);
    ...
    Assert.IsTrue(object.ReferenceEquals(user.KeyFile, (object)bs));
